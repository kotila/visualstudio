...
namespace StockTools
{
    class MysqlTools
    {
        ...
        DataSet dataSet;
        string IP = "54.217.254.166";
        string UserName = "root";
        string Password = "equery!@#*()";
        string Database = "storage_db";
        /// <summary>
        /// 建立mysql连接
        /// </summary>
        public MysqlTools()
        ...
        public MysqlTools(string IP, string UserName, string Password, string Database)
        {
            try
            {
        ...
        public int MysqlCommand(string MysqlCommand)
        {
            ...
            {
                mysqlConnection.Open();
                Console.WriteLine("MysqlTools Opened.");
        ...
        /// 执行select 语句返回执行结果
        /// </summary>
        public DataView MysqlDataAdapter(string mysqlQuery,string table)
        {
